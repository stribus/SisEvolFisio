...
type
  TfrmPaciente = class(TForm)
    ...
    pnl1: TPanel;
    lbl1: TLabel;
    redtDiagClinico: TRichEdit;
    pnl2: TPanel;
    lbl2: TLabel;
    redtAvalFisio: TRichEdit;
    pnl3: TPanel;
    lbl3: TLabel;
    redtdiagFisio: TRichEdit;
    pnl4: TPanel;
    lbl4: TLabel;
    redtObjetivo: TRichEdit;
    pnl5: TPanel;
    lbl5: TLabel;
    redtCondutaFisio: TRichEdit;
    pnl6: TPanel;
    lblEvolucoes: TLabel;
    ...
    bdsdbPacientes: TBindSourceDB;
    bdl1: TBindingsList;
    lpfLinesText: TLinkPropertyToField;
    lpfLinesText1: TLinkPropertyToField;
